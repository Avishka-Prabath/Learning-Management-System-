...
// Dynamic or Fixed Course ID for ICT
$course_id = isset($_GET['course_id']) ? intval($_GET['course_id']) : 3;

// 1. Fetch ICT Course Info
...
$course_name = $courseData['course_name'] ?? 'BSc (Hons) in Information & Comm. Tech';
$course_code = $courseData['course_code'] ?? 'ICT-2026';

// 2. Auto-Seeding ICT Modules if Database is empty for this Course ID
...
if ($totalCount == 0) {
    ...
    $ictSubjects = [
        // Year 01
        ['ICT 1101', 'Information Technology Fundamentals', 'Semester 01', '#0d6efd'],
        ['ICT 1102', 'Structured Programming Fundamentals', 'Semester 01', '#0284c7'],
        ['ICT 1103', 'Computer System Architecture & Hardware', 'Semester 01', '#059669'],
        ['ICT 1201', 'Database Management Systems & SQL', 'Semester 02', '#d97706'],
        ['ICT 1202', 'Data Communication & Computer Networks', 'Semester 02', '#7c3aed'],
        ['ICT 1203', 'Web Technologies & Internet Systems', 'Semester 02', '#dc2626'],
        // Year 02
        ['ICT 2101', 'Object-Oriented Analysis & Design', 'Semester 03', '#0d6efd'],
        ['ICT 2102', 'System Administration & OS Concepts', 'Semester 03', '#0284c7'],
        ['ICT 2103', 'Information Systems & Enterprise Security', 'Semester 03', '#059669'],
        ['ICT 2201', 'E-Commerce & Digital Business Systems', 'Semester 04', '#d97706'],
        ['ICT 2202', 'Wireless Networks & Mobile Computing', 'Semester 04', '#7c3aed'],
        ['ICT 2203', 'Human-Computer Interaction (HCI)', 'Semester 04', '#dc2626'],
        // Year 03
        ['ICT 3101', 'Cloud Infrastructure & Virtualization', 'Semester 05', '#0284c7'],
        ['ICT 3102', 'IT Project Management & Quality Assurance', 'Semester 05', '#059669'],
        ['ICT 3103', 'Data Science & Business Intelligence Basics', 'Semester 05', '#d97706'],
        ['ICT 3201', 'Cyber Law, Ethics & Professional Practice', 'Semester 06', '#7c3aed'],
        ['ICT 3202', 'Advanced Network Routing & Switching', 'Semester 06', '#dc2626'],
        // Year 04
        ['ICT 4101', 'Enterprise Resource Planning (ERP) Systems', 'Semester 07', '#059669'],
        ['ICT 4102', 'IoT Infrastructure & Smart Systems', 'Semester 07', '#d97706'],
        ['ICT 4201', 'Final Year Industrial IT Research & Capstone Project', 'Semester 08', '#0d6efd']
    ];

    foreach ($ictSubjects as $ict) {
        $insStmt->bind_param("issss", $course_id, $ict[0], $ict[1], $ict[2], $ict[3]);
        $insStmt->execute();
    }
    $insStmt->close();
}

// 3. Fetch All ICT Modules
