...
// Course ID for Business Management
$course_id = isset($_GET['course_id']) ? intval($_GET['course_id']) : 4;

// 1. Fetch Business Management Course Info
...
$course_name = $courseData['course_name'] ?? 'BSc (Hons) in Business Management';
$course_code = $courseData['course_code'] ?? 'BM-2026';

// 2. Auto-Seeding BM Modules if Database is empty for this Course ID
...
if ($totalCount == 0) {
    ...
    $bmSubjects = [
        // Year 01
        ['BM 1101', 'Principles of Management & Organization', 'Semester 01', '#0d6efd'],
        ['BM 1102', 'Fundamentals of Marketing', 'Semester 01', '#0284c7'],
        ['BM 1103', 'Business Accounting & Finance', 'Semester 01', '#059669'],
        ['BM 1201', 'Organizational Behavior', 'Semester 02', '#d97706'],
        ['BM 1202', 'Microeconomics for Managers', 'Semester 02', '#7c3aed'],
        ['BM 1203', 'Business Communication & Soft Skills', 'Semester 02', '#dc2626'],
        // Year 02
        ['BM 2101', 'Human Resource Management (HRM)', 'Semester 03', '#0d6efd'],
        ['BM 2102', 'Operations & Supply Chain Management', 'Semester 03', '#0284c7'],
        ['BM 2103', 'Business Statistics & Analytics', 'Semester 03', '#059669'],
        ['BM 2201', 'Corporate Law & Business Ethics', 'Semester 04', '#d97706'],
        ['BM 2202', 'Digital Marketing & E-Commerce', 'Semester 04', '#7c3aed'],
        ['BM 2203', 'Managerial Economics', 'Semester 04', '#dc2626'],
        // Year 03
        ['BM 3101', 'Strategic Management & Business Policy', 'Semester 05', '#0284c7'],
        ['BM 3102', 'Financial Management & Decision Making', 'Semester 05', '#059669'],
        ['BM 3103', 'Entrepreneurship & New Venture Creation', 'Semester 05', '#d97706'],
        ['BM 3201', 'International Business & Global Trade', 'Semester 06', '#7c3aed'],
        ['BM 3202', 'Project Management & Risk Analysis', 'Semester 06', '#dc2626'],
        // Year 04
        ['BM 4101', 'Innovation & Enterprise Change Management', 'Semester 07', '#059669'],
        ['BM 4102', 'Corporate Governance & Sustainability', 'Semester 07', '#d97706'],
        ['BM 4201', 'Final Year Business Research & Consultancy Project', 'Semester 08', '#0d6efd']
    ];

    foreach ($bmSubjects as $bm) {
        $insStmt->bind_param("issss", $course_id, $bm[0], $bm[1], $bm[2], $bm[3]);
        $insStmt->execute();
    }
    $insStmt->close();
}

// 3. Fetch All BM Modules
                                    ...
                                    <div class="card-body p-3.5 d-flex flex-column justify-content-between">
                                        ...
                                        <div class="pt-3 border-top mt-3">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pt-1">
                                                ...
                                                <!-- NEW DIRECT LINK TO LECTURE CONTENT PAGE -->
